...
def calculates_results_stats(results_dic):
    ...
    results_stats_dic['n_correct_dogs'] = sum(results_dic[key][4] for key in results_dic if results_dic[key][3] == 1)
    results_stats_dic['n_correct_notdogs'] = sum(1 for key in results_dic if results_dic[key][3] == 0 and results_dic[key][4] == 0)
    results_stats_dic['n_correct_breed'] = sum(results_dic[key][2] for key in results_dic if results_dic[key][3] == 1)
